...
mod tests {
    ...
    #[test_case(
        domain::ThemeKind::try_new("hoge").unwrap(),
        vec![
            domain::Theme::new(
                domain::Id::new("1234"),
                domain::ThemeKind::try_new("hoge").unwrap(),
            ...
            domain::Theme::new(
                domain::Id::new("2345"),
                domain::ThemeKind::try_new("hoge").unwrap(),
                domain::Word::try_new("first_hoge2").unwrap(),
                domain::Word::try_new("second_hoge2").unwrap(),
            ),
        ]=>Ok(vec![
                domain::Theme::new(
                    domain::Id::new("1234"),
    ...
    #[test_case(
        ...
        vec![
            ...
            domain::Theme::new(
                domain::Id::new("3456"),
                domain::ThemeKind::try_new("hoge2").unwrap(),
                domain::Word::try_new("first_hoge3").unwrap(),
                domain::Word::try_new("second_hoge3").unwrap(),
            ),
        ]=>Ok(vec![
                domain::Theme::new(
                    domain::Id::new("1234"),
    ...
    ;"get_multiple_theme_witout_not_kind_match")]
    #[async_std::test]
